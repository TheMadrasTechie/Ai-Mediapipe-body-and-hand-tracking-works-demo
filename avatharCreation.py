...
cap = cv2.VideoCapture('videos/body2.mp4')
fourcc = cv2.VideoWriter_fourcc(*'XVID')
output = cv2.VideoWriter('avathar-body.mp4', fourcc, 24, (4096, 2160))
output1 = cv2.VideoWriter('avathar-body-avatae.mp4', fourcc, 24, (4096, 2160))
#cap = cv2.VideoCapture("videos/sundar.mp4")
